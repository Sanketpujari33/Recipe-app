...
- The HTML code creates elements that are necessary to create the structure of the app.
...
- we need to style these elements
...
- We add functionality to this project using Javascript.
